...
import { ServerCrash, Menu } from 'lucide-react';
  ...
  return (
    <header className="app-header">
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        <div className="header-status" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginLeft: '2rem' }}>
      ...
      <div className="header-metrics" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        <div className="header-chart" style={{ width: '120px', height: '40px' }}>
